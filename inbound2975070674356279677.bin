--// THIS FILE CREATED BY NGUYEN ANH TUAN
print("--> [NAT LIBRARY] : ui library load success!");

if getgenv().Nousigi then 
	if game.CoreGui:FindFirstChild("Nguyen Anh Tuan GUI") then
		for i, v in ipairs(game.CoreGui:GetChildren()) do
			if string.find(v.Name,  "Nguyen Anh Tuan") then
				v:Destroy()
			end
		end
	end
...
local T1UIColor = {
    ...
    ["Click Effect Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Setting Icon Color"] = Color3.fromRGB(200, 200, 200),
    ["Logo Image"] = "rbxassetid://89123391788498",
    ["Search Icon Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Search Icon Highlight Color"] = Color3.fromRGB(50, 200, 255), -- Xanh sáng hơn khi di chuột
    ["GUI Text Color"] = Color3.fromRGB(240, 240, 240), -- Giữ nguyên (Chữ)
    ["Text Color"] = Color3.fromRGB(240, 240, 240), -- Giữ nguyên (Chữ)
    ["Placeholder Text Color"] = Color3.fromRGB(100, 100, 100),
    ["Title Text Color"] = Color3.fromRGB(255, 255, 255), -- Giữ nguyên (Tiêu đề phải màu trắng mới nổi)
    ...
    ["Page Selected Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Section Text Color"] = Color3.fromRGB(255, 255, 255), -- Giữ nguyên (Chữ mục con)
    ["Section Underline Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Toggle Border Color"] = Color3.fromRGB(70, 70, 70),
    ["Toggle Checked Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Toggle Desc Color"] = Color3.fromRGB(180, 180, 180),
    
    ["Button Color"] = Color3.fromRGB(35, 35, 35),
    ["Label Color"] = Color3.fromRGB(28, 28, 28),
    ["Dropdown Icon Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Dropdown Selected Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Dropdown Selected Check Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi màu dấu tích sang Xanh Dương
    
    ["Textbox Highlight Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Box Highlight Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
    ["Slider Line Color"] = Color3.fromRGB(45, 45, 45),
    ["Slider Highlight Color"] = Color3.fromRGB(0, 170, 255), -- Đã đổi sang Xanh Dương
...
Library_Function.Gui.Name = 'Nguyen Anh Tuan GUI'
...
ImageLabel.Image = "rbxassetid://89123391788498"
...
Library.ToggleUI = function()
    ...
    if game.CoreGui:FindFirstChild("Nguyen Anh Tuan GUI") then
        for a, b in ipairs(game.CoreGui:GetChildren()) do
            if b.Name == "Nguyen Anh Tuan GUI" then
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,80,80") .. ")\">" .. tostring(TitleNameMain or "Nguyen Anh Tuan") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Title or "Nguyen Anh Tuan"
   ...
   TextLabelMain.Text = "<font color=\"rgb(0,0,0)\">" .. tostring(TitleNameMain or "Nguyen Anh Tuan") .. "</font> <font color=\"rgb(255,255,255)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
